...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-03-2025 a las 07:16:02
...
INSERT INTO `pregunta` (`id_pregunta`, `id_seguimiento`, `preguntas`, `tipo_pregunta`) VALUES
(1, 1, '[\"¿Cómo calificaría nuestro servicio?\", \"¿Recomendaría nuestra empresa?\", \"¿Con qué frecuencia compra?\", \"¿Qué productos prefiere?\"]', '[\"Respuesta Corta\", \"Respuesta Corta\", \"Respuesta Corta\", \"Respuesta Corta\"]'),
(2, 2, '[\"¿Cómo nos conoció?\", \"¿Qué tan satisfecho está?\", \"¿En qué podemos mejorar?\",\"¿Cómo calificaría nuestro servicio?\"]', '[\"Respuesta Corta\", \"Párrafo\", \"Párrafo\", \"Casillas de Verificación\"]'),
(3, 3, '[\"¿Ha usado nuestro servicio antes?\", \"¿Cómo nos compara con la competencia?\", \"¿Volvería a comprar con nosotros?\"]', '[\"Respuesta Corta\", \"Párrafo\", \"Respuesta Corta\", \"Respuesta Corta\"]'),
(4, 4, '[\"¿Cuánto tiempo ha sido nuestro cliente?\", \"¿Qué promociones le gustaría ver?\", \"¿Qué cambiaría de nuestra atención al cliente?\"]', '[\"Respuesta Corta\", \"Respuesta Corta\", \"Respuesta Corta\", \"Respuesta Corta\"]');
...
--
ALTER TABLE `pregunta`
  ADD CONSTRAINT `pregunta_ibfk_1` FOREIGN KEY (`id_seguimiento`) REFERENCES `seguimiento` (`id_seguimiento`);
